# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in geoip.
...
base_config.model = geoip.model
base_config.DBSession = geoip.model.DBSession
